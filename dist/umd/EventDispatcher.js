...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@tsdotnet/disposable", "@tsdotnet/exceptions", "@tsdotnet/lazy", "@tsdotnet/ordered-registry"], factory);
    }
    ...
    class EventDispatcher extends disposable_1.DisposableBase {
        ...
        _registry;
        _behavior;
        _publicSubscribe = lazy_1.Lazy.create(() => Object.freeze(this.createSubscribe()));
        _publicEvent = lazy_1.Lazy.create(() => {
        ...
        _autoDispose = lazy_1.Lazy.create(() => new EventDispatcher());
